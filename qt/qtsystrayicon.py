...
class QtSysTrayIcon:
    ...
    def updateInfo(self):
        ...
        if pg.fileReadable():
            pg.load()
            ## percent variable is unused after bug fix - #902
    ...
    def onStartBIT(self):
        ...
        ## Process is assigned to 'proc' for potential management; keeping it as is and disabling pylint check.
        proc = subprocess.Popen(cmd) # pylint: disable=unused-variable
